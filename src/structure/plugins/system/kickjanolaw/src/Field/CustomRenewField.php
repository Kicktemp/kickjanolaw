...
class CustomRenewField extends FormField
{
	/**
	 * The form field type.
	 *
	...
	public function getInput()
	{
		Factory::getDocument()->getWebAssetManager()
			->registerAndUseScript('plg_system_kickjanolaw.custom-renew', 'plg_system_kickjanolaw/kickjanolaw-custom-renew.js', [], [], ['core']);
