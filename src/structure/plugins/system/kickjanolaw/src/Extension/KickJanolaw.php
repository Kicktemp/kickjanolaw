...
namespace Kicktemp\Plugin\System\Janolaw\Extension;
...
class KickJanolaw extends CMSPlugin implements SubscriberInterface
{
    /**
     * The language object
     *
    ...
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            'onAjaxCustomRenew' => 'onAjaxCustomRenew',
            'onAjaxVersionCheck' => 'onAjaxVersionCheck'
        ];
    }
    ...
    public function _load($type, $language = 'de', $cache_time = 7200, $ajax = false)
    {
        ...
        else
        {
            ...
            return Text::_('PLG_SYSTEM_KICKJANOLAW_CONTENT_ERROR');
        }
    }
    ...
    public function onAjaxCustomRenew()
    {
        ...
        $lang = $app->input->get('postlanguage');
    ...
    public function onAjaxVersionCheck()
    {
        ...
        if ($content)
        {
            ...
            if ($content)
            {
                echo '<br><div class="alert alert-success">' . Text::_('PLG_SYSTEM_KICKJANOLAW_MULTILANGUAGE') . '</div>';
            }
            else
            {
                echo '<br><div class="alert alert-info">' . Text::_('PLG_SYSTEM_KICKJANOLAW_NO_MULTILANGUAGE');
            }
        }
        else
        {
            echo '<br><div class="alert alert-danger">' . Text::_('PLG_SYSTEM_KICKJANOLAW_VERSION_NO_3') . '</div>';
        }
